...
#### IMPORTANT !! ####
### Define these variables to be able to use the API client for the corresponding services ###

#uncomment the line below and define the e-mail address to be used with Unpaywall
...
#uncomment the line below and define your Lens token
#os.environ['LENS_TOKEN'] =

#uncomment the line below and define your Altmetric API key
#os.environ['ALTMETRICS_API_KEY'] =
